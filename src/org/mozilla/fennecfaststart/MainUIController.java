...
import org.mozilla.fennecfaststart.AwesomeBarController;
import org.mozilla.fennecfaststart.GeckoSurfaceView;
...
public class MainUIController {
    ...
    private void build() {
        ...
        // Content
        // GeckoSurfaceView contentView = new GeckoSurfaceView(activity);
        mController = new SurfaceTestController(activity);
        View contentView = mController.getLayout();
